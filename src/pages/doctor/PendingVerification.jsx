...
// Import API directly to ensure it's available
...
const PendingVerification = () => {
  ...
  useEffect(() => {
    ...
    const fetchVerificationStatus = async () => {
      try {
        ...
        // Make a direct fetch call instead of using the API client
        // This will work even if the API client is not properly initialized
        ...
        const response = await fetch(`${apiUrl}/api/verification/doctors/verification-status`, {
          method: 'GET',
          headers: {
  ...
  // Always show a UI, even if there's an error or no data
  return (
