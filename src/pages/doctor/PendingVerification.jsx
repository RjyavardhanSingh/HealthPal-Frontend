...
const PendingVerification = () => {
  ...
  useEffect(() => {
    ...
    const fetchVerificationStatus = async () => {
      try {
        ...
        if (!api || !api.verification || !api.verification.getStatus) {
        ...
        // Don't show toast here - it can cause confusion on blank page
      } finally {
        setLoading(false);
      }
    };
  ...
  // Add this fallback UI if there's an error loading or API issues
                ...
                <div className="flex">
                  <div className="flex-shrink-0">
                    ...
                    >
                      <path
                        fillRule="evenodd"
                        d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-1 9a1 1 0 100-2h.01a1 1 0 100 2H10z"
                        clipRule="evenodd"
                      />
                    </svg>
                  </div>
  ...
  // Regular UI with verification status data
  return (
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full space-y-8 mx-auto">
        <div>
        ...
        <div className="bg-white shadow overflow-hidden sm:rounded-lg">
          <div className="px-4 py-5 sm:p-6">
            ...
            {verificationStatus.request &&
              verificationStatus.request.status === 'additional_info_requested' && (
                  ...
                  <div className="flex">
                    <div className="flex-shrink-0">
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7-4a1 1 0 11-2 0 1 1 0 012 0zm-1 4a1 1 0 100 2h.01a1 1 0 100-2H10z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </div>
                    <div className="ml-3">
                      ...
                      <p className="mt-1 text-sm text-amber-700">
                        {verificationStatus.request.adminNotes ||
                          'Please provide additional documents to complete verification.'}
                      </p>
                    </div>
                  </div>
                </div>
